...
vmovapd 0x100(%rsi,%r8,1),%ymm1           # Move the value of the b-array (offset by r8 + 512) to ymm1
vmovapd 0x200(%rsi,%r8,1),%ymm2           # Move the value of the b-array (offset by r8 + 1024) to ymm2
vmovapd 0x300(%rsi,%r8,1),%ymm3           # Move the value of the b-array (offset by r8 + 1536) to ymm3
...
vbroadcastsd 0x100(%rdi, %r10, 1), %ymm9  # Basically the same as the first "vbroadcastsd" block
VFMADD231PD %ymm9, %ymm0, %ymm5
vbroadcastsd 0x108(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm1, %ymm5
vbroadcastsd 0x110(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm2, %ymm5
vbroadcastsd 0x118(%rdi, %r10, 1), %ymm9
...
vbroadcastsd 0x300(%rdi, %r10, 1), %ymm9  # Basically the same as the first "vbroadcastsd" block
VFMADD231PD %ymm9, %ymm0, %ymm7
vbroadcastsd 0x308(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm1, %ymm7
vbroadcastsd 0x310(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm2, %ymm7
vbroadcastsd 0x318(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm3, %ymm7

add $0x400,%r8                            # Add 2048 to r8
add $0x20,%rcx                            # Add 32 to rcx
cmp $0x100,%rcx                           # Compare rcx to 512
...
vmovapd %ymm5,0x100(%rdx,%r10,1)          # Move the value in ymm5 to the c-array offset by r10 + 512
vmovapd %ymm6,0x200(%rdx,%r10,1)          # Move the value in ymm6 to the c-array offset by r10 + 1024
vmovapd %ymm7,0x300(%rdx,%r10,1)          # Move the value in ymm7 to the c-array offset by r10 + 1536

add $0x20,%r9                             # Add 32 to the value in r9
cmp $0x100,%r9                            # Compare r9 to 512
jne label2                                # Jump to label2 if r9 != 512

add $0x400,%rax                           # Add 2048 to the value in rax
cmp $0x2000,%rax                          # Compare rax to 32768
