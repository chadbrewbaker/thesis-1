...
vmovapd 0x400(%rsi,%r8,1),%ymm1           # Move the value of the b-array (offset by r8 + 512) to ymm1
vmovapd 0x800(%rsi,%r8,1),%ymm2           # Move the value of the b-array (offset by r8 + 1024) to ymm2
vmovapd 0xC00(%rsi,%r8,1),%ymm3           # Move the value of the b-array (offset by r8 + 1536) to ymm3
...
vbroadcastsd 0x800(%rdi, %r10, 1), %ymm9  # Basically the same as the first "vbroadcastsd" block
VFMADD231PD %ymm9, %ymm0, %ymm6
vbroadcastsd 0x808(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm1, %ymm6
vbroadcastsd 0x810(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm2, %ymm6
vbroadcastsd 0x818(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm3, %ymm6

vbroadcastsd 0xC00(%rdi, %r10, 1), %ymm9  # Basically the same as the first "vbroadcastsd" block
VFMADD231PD %ymm9, %ymm0, %ymm7
vbroadcastsd 0xC08(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm1, %ymm7
vbroadcastsd 0xC10(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm2, %ymm7
vbroadcastsd 0xC18(%rdi, %r10, 1), %ymm9
VFMADD231PD %ymm9, %ymm3, %ymm7

add $0x1000,%r8                            # Add 2048 to r8
add $0x20,%rcx                            # Add 32 to rcx
cmp $0x400,%rcx                           # Compare rcx to 512
...
vmovapd %ymm5,0x400(%rdx,%r10,1)          # Move the value in ymm5 to the c-array offset by r10 + 512
vmovapd %ymm6,0x800(%rdx,%r10,1)          # Move the value in ymm6 to the c-array offset by r10 + 1024
vmovapd %ymm7,0xC00(%rdx,%r10,1)          # Move the value in ymm7 to the c-array offset by r10 + 1536

add $0x20,%r9                             # Add 32 to the value in r9
cmp $0x400,%r9                            # Compare r9 to 512
jne label2                                # Jump to label2 if r9 != 512

add $0x1000,%rax                           # Add 2048 to the value in rax
cmp $0x20000,%rax                          # Compare rax to 32768
